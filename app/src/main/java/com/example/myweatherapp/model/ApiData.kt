...
data class Day(
    ...
    @SerializedName("maxtemp_c") var maxtempC: String,
    @SerializedName("maxtemp_f") var maxtempF: String,
    @SerializedName("mintemp_c") var mintempC: String,
    @SerializedName("mintemp_f") var mintempF: String,
    @SerializedName("avgtemp_c") var avgtempC: String,
    @SerializedName("avgtemp_f") var avgtempF: String,
    @SerializedName("maxwind_mph") var maxwindMph: String,
    @SerializedName("maxwind_kph") var maxwindKph: String,
    @SerializedName("totalprecip_mm") var totalprecipMm: String,
    ...
    @SerializedName("avghumidity") var avghumidity: String,
    @SerializedName("daily_will_it_rain") var dailyWillItRain: Int,
    @SerializedName("daily_chance_of_rain") var dailyChanceOfRain: String,
